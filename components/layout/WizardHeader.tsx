                ...
                {step.status === 'complete' ? (
                  ...
                  >
                    <span className="flex items-center px-6 py-4 text-sm font-medium">
                      <span className="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-green-500 rounded-full group-hover:bg-green-600">
                  ...
                  <button
                    ...
                    aria-current="step"
                  >
                    <span className="flex-shrink-0 w-10 h-10 flex items-center justify-center border-2 border-blue-500 rounded-full">
